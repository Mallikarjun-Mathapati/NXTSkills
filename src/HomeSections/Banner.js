    ...
    <>
      <div className="banner flex">
        <div className="containe">
          <div className="flex banner-flex">
            <div className="banner-grid">
              <div className="banner-grid-content">
                <h4>NXTSkills One-Stop IT Solutions Providers.</h4>
                <p>
                  IT is not just a department, it's the backbone of
                  organizations success. Leveraging our experience and
                  knowledge, we offer a wide array of services tailored to meet
